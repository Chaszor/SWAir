...
function checkWeight($weight){
    if ($weight <= MAX_WEIGHT) {
        //echo "<script>alert('The weight of the bag is within the allowed limit.');</script>";
    } else {
        echo "<script>alert('The weight of the bag exceeds the 50 kg limit.');</script>";
        echo "<script>window.location.href = 'baggage_form.php';</script>";
        exit();
    }
